...
<?php if (!empty($this->options->sidebarBlock) && in_array('ShowAuthor', $this->options->sidebarBlock)): ?>
			...
			<div class="photo-background"><div class="photo-background" style="background:url('https://ali.moe2.works/image/202304011612538.png') no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;"></div></div>
			<div class="photo-wrapper clearfix"><div class="photo-wrapper-tip text-center"> <img class="about-photo" src=https://ali.moe2.works/image/202304011605043.png></div></div>
