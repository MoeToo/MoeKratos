...
<?php if (!empty($this->options->sidebarBlock) && in_array('ShowAuthor', $this->options->sidebarBlock)): ?>
			...
			<div class="photo-background"><div class="photo-background" style="background:url('<?php if ($this->options->SidebarBackground): ?><?php $this->options->SidebarBackground(); ?><?php else: ?><?php endif; ?>') no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;"></div></div>

			<div class="photo-wrapper clearfix"><div class="photo-wrapper-tip text-center"> <img class="about-photo" src=<?php if ($this->options->authorpic): ?><?php $this->options->authorpic(); ?><?php else: ?><?php endif; ?>></div></div>

			<div class="textwidget"><?php if ($this->options->authordesc): ?><?php $this->options->authordesc(); ?><?php else: ?><?php endif; ?></div>
